...
class Ekf 
{
 ...
 // to retain angle for next step
  ...
  Matrix<double, 2, 1> _roll_pitch_no_filter;
  Matrix<double, 2, 1> _acc_angle_no_filter;

  Matrix<double, 3, 2> _get_trigonometric(const Matrix<double, 2, 1>& roll_pitch);
  ...
  geometry_msgs::Vector3 _get_corrected_angle(const Matrix<double, 2, 1>& pre_roll_pitch, 
