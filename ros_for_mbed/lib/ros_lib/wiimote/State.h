...
namespace wiimote
{
  ...
  class State : public ros::Msg
  {
    ...
    State():
      ...
      LEDs(),
      rumble(0),
      ir_tracking_length(0), st_ir_tracking(), ir_tracking(nullptr),
      raw_battery(0),
      percent_battery(0),
      zeroing_time(),
      errors(0)
    ...
    virtual const char * getType() override { return "wiimote/State"; };
    virtual const char * getMD5() override { return "a69651e8129655c6ed3c5039e468362c"; };
